...
func formula_term_converter(formula:String, ficha:Dictionary, dif):
	formula = formula.replace("f", ficha.stat.multiplicado[0])
	formula = formula.replace("d", ficha.stat.multiplicado[1])
	formula = formula.replace("r", ficha.stat.multiplicado[2])
	formula = formula.replace("i", ficha.stat.multiplicado[3])
	formula = formula.replace("e", ficha.stat.multiplicado[4])
